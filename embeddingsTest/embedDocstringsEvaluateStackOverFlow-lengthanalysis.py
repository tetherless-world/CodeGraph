...
#            labeltotextmap[docLabel] = docStringText
        ...
        return (index, docMessages, embeddingtolabelmap, docStringLength_avg,droppedClassWithLessLength)


def evaluate_neighbors(index, docMessages, embeddingtolabelmap,docStringLength_avg,droppedClassWithLessLength):
    k = 10
    fp=0
    fn=0
    tp=0
...
if __name__ == '__main__':
    ...
    evaluate_neighbors(dataTuple[0], dataTuple[1], dataTuple[2], dataTuple[3],dataTuple[4])
