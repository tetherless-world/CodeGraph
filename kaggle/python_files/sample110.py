...
# This version uses outlier labeling and stratification from [this kernel](https://www.kaggle.com/chauhuynh/my-first-kernel-3-699).
...
train_stack = np.vstack([oof_lgb, oof_lgb_3, oof_xgb_3]).transpose()
