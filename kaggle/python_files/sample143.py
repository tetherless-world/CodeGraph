...
# - clean numbers, split numbers and letters
# - de-contract the contraction
# - clean math latex
# - clean many misspelling words
# - spacing punctuations expect `-`and `.`
# - **fix `-`and `.` punc spacing bugs which common kernels existed**
# - spacing some connected words like `whatis, whichcountry`
# - clean repeated letters in one word, like `hoooooow`
# - clean some masked words like `f***, st*up*id`
# 
# Reference:
...
# 
# Cleaning text data has caused me huge time! **Please UPVOTE if you find it useful**
...
# All of the cleaning kernels I found that, they add space around all punctuations. There is a litter bug when spacing dash `-` and point `.`, it will drop the word coverage. For example, the words like `self-trust`, `Michelin-starred` and `pro-Islamic` these words already have pretrained embeddings, force break these words will decrease the word coverage! **I have found 18128 words like this.**
