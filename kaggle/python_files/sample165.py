...
# - this is the kernel fork of Simple 2d-CNN Classifier with PyTorch by mhiro2.
#   - https://www.kaggle.com/mhiro2/simple-2d-cnn-classifier-with-pytorch
# - I made this kernel referring to below github repository, facebookresearch/mixup-cifar10
#   - https://github.com/facebookresearch/mixup-cifar10
# - And I got insight from Freesound General-Purpose Audio Tagging Challenge's 8th place solution.
#   - https://www.kaggle.com/c/freesound-audio-tagging/discussion/64262
# - I add mixup for augment, each batch.
...
Classifier(num_classes=num_classes).cuda()
...
# calclulate loss with mixup data
# https://github.com/facebookresearch/mixup-cifar10/blob/master/train.py
...
def train_model(x_train, y_train, train_transforms):
    ...
    eta_min = 1e-5
    t_max = 10
    alpha = 0.7    # add mixup ration parameter
    ...
    for epoch in mb:
        ...
        for x_batch, y_batch in progress_bar(train_loader, parent=mb):
            ...
            # mixup
            inputs, targets_a, targets_b, lam = mixup_data(x_batch.cuda(), y_batch.cuda(), alpha)
            inputs, targets_a, targets_b = map(Variable, (inputs, targets_a, targets_b))
  
            # modify to use mixup data
