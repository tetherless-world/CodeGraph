...
history = model.fit(x_train[2000:],y_train[2000:],epochs = 100,batch_size = 25,validation_data = (x_val,y_val),callbacks = [model_check_point,early_stopping,reduce_lr_on_plateau])
...
plt.show()
'''
model.fit(x_train,y_train,epochs = 42,batch_size = 25)
