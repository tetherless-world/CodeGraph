...
# 
# - Because of that, the whole purpose of the validation set now is to help us choose a single threshold, so we remove it completely and take the computed value of **0.33** from the original kernel.
# 
# - We are able to train our model on the full data set thanks to that.
# 
# - More data = more score (yay?).
# 
# Anyway, I hope you don't take this kernel too seriously. This ensemble thingy is pure madness for me recently, seems like focusing on a single, robus model is still the thing to do. Have fun.
