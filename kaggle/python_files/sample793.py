...
# ## Prediction Results
# * **I made predictions almost 6 months ago** about points of people who is in kernel ranking.
# * My correct predictions are: 
#     * SRK ( predicted = 1143, real = 1155), 
#     * anokas (predicted = 795,real = 800  ), 
#     * Jonathan Bouched (predicted = 454, real = 441), 
#     * Faran(predicted = 179, real = 162), 
#     * Kaan Can(predicted = 994, real = 1001)
# * My other predictions are totally wrong :)
# * I add this part just for fun.
